...
from wasteDetection.utils.mian_utils import decodeImage, encodeImmageIntoBase64
...
def predictRoute():
    try:
        ...
        opencodedbase64 = encodeImmageIntoBase64("yolov5/runs/detect/exp/inputImage.jpg")
